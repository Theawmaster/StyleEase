...
const HighlightPage = () => {
  ...
  return (
    <ScrollView
      style={styles.highlightPage}
      horizontal={false}
      showsVerticalScrollIndicator={true}
      showsHorizontalScrollIndicator={true}
      contentContainerStyle={styles.highlightPageScrollViewContent}
    >
      <View style={styles.highlight}>
        <View style={[styles.colourHighlights, styles.rectangle4Position]}>
        ...
        <View style={[styles.highlightContent, styles.containersFlexBox]}>
          <View style={styles.card}>
            <Image
              style={styles.backgroundIcon}
              contentFit="cover"
          ...
          <View style={styles.sliderFilter}>
            ...
            <TouchableHighlight
              style={[styles.tag9, styles.tagFlexBox]}
              underlayColor="#fff"
              activeOpacity={0.2}
            ...
            <View style={[styles.tag10, styles.tagFlexBox]}>
              <Text style={[styles.topHair, styles.thickTypo]}>Highlight</Text>
            </View>
            <View style={[styles.tag3, styles.tagLayout]} />
            <View style={[styles.tag4, styles.tagLayout]} />
          </View>
          ...
          <View style={styles.list1}>
            <Image
              style={styles.listChild}
              contentFit="cover"
              source={require("../assets/rectangle-154716.png")}
            />
            <View style={styles.combBackParent}>
              <Text style={styles.buzzCut}>Blonde</Text>
              <Image
                style={styles.frameChild}
                contentFit="cover"
                source={require("../assets/ellipse-260.png")}
          ...
          <View style={styles.list1}>
            <Image
              style={styles.listChild}
              contentFit="cover"
              source={require("../assets/rectangle-154717.png")}
            />
            <View style={styles.listInner}>
              <View style={styles.buzzCutParent}>
                <Text style={styles.buzzCut}>Ash grey</Text>
                <Image
                  style={styles.frameChild}
                  contentFit="cover"
                  source={require("../assets/ellipse-260.png")}
          ...
          <View style={styles.list1}>
            <Image
              style={styles.listChild}
              contentFit="cover"
              source={require("../assets/slickback5.png")}
            />
            <View style={styles.combBackParent}>
              <Text style={styles.buzzCut}>Sapphire</Text>
              <Image
                style={styles.frameChild}
                contentFit="cover"
                source={require("../assets/ellipse-260.png")}
          ...
          <View style={styles.list1}>
            <Image
              style={styles.listChild}
              contentFit="cover"
              source={require("../assets/rectangle-154718.png")}
            />
            <View style={styles.listInner}>
              <View style={styles.buzzCutParent}>
                <Text style={styles.buzzCut}>Red strips</Text>
                <Image
                  style={styles.frameChild}
                  contentFit="cover"
                  source={require("../assets/ellipse-260.png")}
...
const styles = StyleSheet.create({
  highlightPageScrollViewContent: {
    flexDirection: "row",
