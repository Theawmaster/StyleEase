    ...
    <View style={[styles.payment, styles.iconLayout]}>
          ...
          <View style={styles.sectionPaymentSummary}>
            ...
            <View style={styles.sectionList}>
              ...
              <View style={[styles.list2, styles.listSpaceBlock]}>
                <Text style={[styles.text, styles.textTypo]}>Service fee</Text>
              ...
              <View style={[styles.list3, styles.listSpaceBlock]}>
                <Text style={[styles.text, styles.textTypo]}>Total price</Text>
      ...
      <View style={[styles.card, styles.cardPosition]}>
        ...
        <View style={styles.titledesc}>
          <Text style={[styles.asStudioHair, styles.textClr]} numberOfLines={1}>
