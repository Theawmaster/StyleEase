...
const BleachPage = () => {
  ...
  return (
    <ScrollView
      style={styles.bleachPage}
      horizontal={false}
      showsVerticalScrollIndicator={true}
      showsHorizontalScrollIndicator={true}
      contentContainerStyle={styles.bleachPageScrollViewContent}
    >
      <View style={styles.bleach}>
        <View style={[styles.colourBleach, styles.colourBleachBg]}>
          ...
          <View style={[styles.topNavigationBar, styles.colourBleachBg]}>
            ...
            <View style={[styles.content, styles.ratingFlexBox]}>
              <View style={styles.label1}>
                ...
                <Text style={[styles.label2, styles.label2Typo, { marginTop: 46 }]}>Back</Text>
              </View>
        ...
        <View style={[styles.bleachContent, styles.containersFlexBox]}>
          <View style={styles.card}>
            <Image
              style={styles.backgroundIcon}
              contentFit="cover"
          ...
          <View style={styles.sliderFilter}>
            <TouchableHighlight
              style={[styles.tag8, styles.tagFlexBox]}
              underlayColor="#fff"
              activeOpacity={0.2}
              onPress={() => navigation.navigate("DyePage")}
            >
              <Text style={[styles.sideHair, styles.longTypo]}>Dye</Text>
            </TouchableHighlight>
            <View style={[styles.tag9, styles.tagFlexBox]}>
              <Text style={[styles.topHair, styles.thickTypo]}>Bleach</Text>
            </View>
            <TouchableHighlight
          ...
          <View style={styles.list1}>
            <Image
              style={styles.listChild}
              contentFit="cover"
              source={require("../assets/rectangle-154712.png")}
            />
            <View style={styles.combBackParent}>
              <Text style={styles.buzzCut}>Red</Text>
              <Image
                style={styles.frameChild}
                contentFit="cover"
                source={require("../assets/ellipse-260.png")}
          ...
          <View style={styles.list1}>
            <Image
              style={styles.listChild}
              contentFit="cover"
              source={require("../assets/rectangle-154713.png")}
            />
            <View style={styles.listInner}>
              <View style={styles.buzzCutParent}>
                <Text style={styles.buzzCut}>Platinum blonde</Text>
                <Image
                  style={styles.frameChild}
                  contentFit="cover"
                  source={require("../assets/ellipse-260.png")}
          ...
          <View style={styles.list1}>
            <Image
              style={styles.listChild}
              contentFit="cover"
              source={require("../assets/slickback4.png")}
            />
            <View style={styles.combBackParent}>
              <Text style={styles.buzzCut}>Mermaid blue</Text>
              <Image
                style={styles.frameChild}
                contentFit="cover"
                source={require("../assets/ellipse-260.png")}
          ...
          <View style={styles.list1}>
            <Image
              style={styles.listChild}
              contentFit="cover"
              source={require("../assets/rectangle-154714.png")}
            />
            <View style={styles.listInner}>
              <View style={styles.buzzCutParent}>
                <Text style={styles.buzzCut}>Fiery orange</Text>
                <Image
                  style={styles.frameChild}
                  contentFit="cover"
                  source={require("../assets/ellipse-260.png")}
          ...
          <View style={styles.list1}>
            <Image
              style={styles.listChild}
              contentFit="cover"
              source={require("../assets/rectangle-154715.png")}
            />
            <View style={styles.listInner}>
              <View style={styles.buzzCutParent}>
                <Text style={styles.buzzCut}>Lime green</Text>
                <Image
                  style={styles.frameChild}
                  contentFit="cover"
                  source={require("../assets/ellipse-260.png")}
