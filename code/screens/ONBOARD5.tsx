...
const ONBOARD5 = () => {
  ...
  return (
    <View style={styles.onboard2}>
      ...
      <Image
        style={[styles.pictureIcon, styles.containersLayout]}
        contentFit="cover"
        source={require("../assets/picture1.png")}
      />
      <View
        style={[styles.pleasedYoungCaucasianMaleB, styles.containersLayout]}
      />
      <View style={[styles.containers, styles.containersLayout]}>
        <View style={styles.sectionDesc}>
          <View style={styles.titledesc}>
            ...
            <Text style={[styles.fretNotYou, styles.fretNotYouFlexBox]}>
              ...
              what you want to do with your hair with our variety of choices and
