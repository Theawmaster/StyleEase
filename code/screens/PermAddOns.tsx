...
const PermAddOns = () => {
  ...
  return (
    <View style={[styles.permAddOns, styles.iconLayout]}>
      <View style={styles.option}>
        <View style={styles.modalHeader}>
          ...
          <TouchableHighlight
            ...
            underlayColor="#fff"
            activeOpacity={0.2}
            onPress={() => navigation.navigate("PermPage")}
          >
            <Image
        ...
        <View style={styles.sectionCategory}>
          ...
          <View style={[styles.listOption, styles.textAreaSpaceBlock]}>
            ...
            <View style={[styles.tag4, styles.tagFlexBox]}>
              <Text style={[styles.text, styles.textTypo]}>Trim</Text>
            </View>
