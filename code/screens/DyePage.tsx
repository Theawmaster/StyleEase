...
const DyePage = () => {
  ...
  return (
    <ScrollView
      style={styles.dyePage}
      horizontal={false}
      showsVerticalScrollIndicator={true}
      showsHorizontalScrollIndicator={true}
      contentContainerStyle={styles.dyePageScrollViewContent}
    >
      <View style={styles.dye}>
        <View style={[styles.colourDye, styles.colourDyeBg]}>
          ...
          <View style={[styles.topNavigationBar, styles.colourDyeBg]}>
            <View style={[styles.statusBar, styles.buttonFlexBox]}>
              ...
              <View style={styles.signalParent}>
                ...
                <View style={styles.battry}>
                  <View style={[styles.rectangle4, styles.colourDyePosition]} />
        ...
        <View style={[styles.dyeContent, styles.containersFlexBox]}>
          <View style={styles.card}>
            <Image
              style={styles.backgroundIcon}
              contentFit="cover"
          ...
          <View style={styles.sliderFilter}>
            <View style={[styles.tag, styles.tagFlexBox]}>
              <Text style={[styles.topHair, styles.thickTypo]}>Dye</Text>
            </View>
            <TouchableHighlight
              style={[styles.tag1, styles.tagFlexBox]}
              underlayColor="#fff"
              activeOpacity={0.2}
              onPress={() => navigation.navigate("BleachPage")}
            >
              <Text style={[styles.sideHair, styles.longTypo]}>Bleach</Text>
            </TouchableHighlight>
            <TouchableHighlight
              style={[styles.tag1, styles.tagFlexBox]}
              underlayColor="#fff"
            ...
            >
              <Text style={[styles.sideHair, styles.longTypo]}>Highlight</Text>
            </TouchableHighlight>
            <View style={[styles.tag3, styles.tagLayout]} />
            <View style={[styles.tag4, styles.tagLayout]} />
          </View>
          ...
          <View style={[styles.listOption1, styles.listFlexBox]}>
            <View style={styles.tag5} />
            <View style={[styles.tag14, styles.tagFlexBox]}>
          ...
          <Text style={[styles.style, styles.styleTypo]}>Color:</Text>
          <View style={styles.list1}>
            <Image
              style={styles.listChild}
              contentFit="cover"
              source={require("../assets/rectangle-15478.png")}
            />
            <View style={styles.combBackParent}>
              <Text style={styles.buzzCut}>{`Black `}</Text>
              <Image
                style={styles.frameChild}
                contentFit="cover"
                source={require("../assets/ellipse-2601.png")}
          ...
          <View style={styles.list1}>
            <Image
              style={styles.listChild}
              contentFit="cover"
              source={require("../assets/rectangle-15479.png")}
            />
            <View style={styles.listInner}>
              <View style={styles.buzzCutParent}>
                <Text style={styles.buzzCut}>Dark coffee brown</Text>
                <Image
                  style={styles.frameChild}
                  contentFit="cover"
                  source={require("../assets/ellipse-260.png")}
          ...
          <View style={styles.list1}>
            <Image
              style={styles.listChild}
              contentFit="cover"
              source={require("../assets/slickback3.png")}
            />
            <View style={styles.combBackParent}>
              <Text style={styles.buzzCut}>Light ash brown</Text>
              <Image
                style={styles.frameChild}
                contentFit="cover"
                source={require("../assets/ellipse-260.png")}
          ...
          <View style={styles.list1}>
            <Image
              style={styles.listChild}
              contentFit="cover"
              source={require("../assets/rectangle-154710.png")}
            />
            <View style={styles.listInner}>
              <View style={styles.buzzCutParent}>
                <Text style={styles.buzzCut}>Medium copper blonde</Text>
                <Image
                  style={styles.frameChild}
                  contentFit="cover"
                  source={require("../assets/ellipse-260.png")}
          ...
          <View style={styles.list1}>
            <Image
              style={styles.listChild}
              contentFit="cover"
              source={require("../assets/rectangle-154711.png")}
            />
            <View style={styles.listInner}>
              <View style={styles.buzzCutParent}>
                <Text style={styles.buzzCut}>Medium blonde red</Text>
                <Image
                  style={styles.frameChild}
                  contentFit="cover"
                  source={require("../assets/ellipse-260.png")}
          ...
          <TouchableHighlight
            ...
            underlayColor="#fff"
            activeOpacity={0.2}
            onPress={() => navigation.navigate("ColourAddOns")}
          >
